...
# Path to PCAWG data
PCAWG_SNV = resource_filename('tensig', 'data/pcawgSNV.h5')
PCAWG_CHROM_SNV = resource_filename('tensig', 'data/pcawgChromSNV.h5')
PCAWG_CHROM_CLUST = resource_filename('tensig', 'data/pcawgChromClust4.h5')
PCAWG_TGCA = resource_filename('tensig', 'data/new_data.h5')
PCAWG_NUC = resource_filename('tensig', 'data/pcawgNuc.h5')
PCAWG_MINMAJ = resource_filename('tensig', 'data/pcawgMinMaj.h5')
PCAWG_MINMAJLIN = resource_filename('tensig', 'data/pcawgMinMajLin.h5') #minMajLinTNC.csv
PCAWG_8DIM = resource_filename('tensig', 'data/pcawg8Dim.h5')

PCAWG_TNC = resource_filename('tensig', 'data/tncTR.csv')
PCAWG_CHRM_TNC = resource_filename('tensig', 'data/chrmTNC3.csv')
PCAWG_CHRM_TNC2 = resource_filename('tensig', 'data/cutoff.4.csv')
PCAWG_NUC_TNC = resource_filename('tensig', 'data/nucTNC.csv')
PCAWG_MINMAJ_TNC = resource_filename('tensig', 'data/minMajTNC.csv')
PCAWG_MINMAJLIN_TNC = resource_filename('tensig', 'data/minMajLinTNC.csv')
PCAWG_8DIM_TNC = resource_filename('tensig', 'data/8dimTNC.csv')

CHROM_CLUST_TNC = resource_filename('tensig', 'data/cutoff.4.unnormed.192.csv')
CHROM_CLUST_IDX = resource_filename('tensig', 'data/indeces.csv')


PCAWG_TNC2 = resource_filename('tensig', 'data/tnc_counts.csv')
FEATURE_TABLE = resource_filename('tensig', 'data/features.csv')
SIMULATION = resource_filename('tensig', 'data/sim_sig.txt')
OTHER = resource_filename('tensig', 'data/other.txt')
ORGANS = resource_filename('tensig', 'data/samples_sorted.csv')

OTHER_MUTATIONS = resource_filename('tensig', 'data/othermut.csv')
MORITZ_OTHER = resource_filename('tensig', 'data/allTable.txt')
MORITZ_TNC = resource_filename('tensig', 'data/tncTransRep.txt')
